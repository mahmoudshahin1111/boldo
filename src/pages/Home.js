    ...
    <div>
      ...
      <div className="section__4">
        <div className="ms__info">
          ...
          <div className="ms__option" onMouseOver={() => switchToImage(0)}>
            <svg
              width="28"
              height="28"
              viewBox="0 0 28 28"
          ...
          <div className="ms__option" onMouseOver={() => switchToImage(1)}>
            <svg
              width="28"
              height="28"
              viewBox="0 0 28 28"
          ...
          <div className="ms__option" onMouseOver={() => switchToImage(2)}>
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
      ...
      <div className="section__5">
        ...
        <div className="ms__cards__section">
          ...
          <div className="ms__card">
            <p>
              “Learning curve <br></br> infrastructure value <br></br>{" "}
              proposition advisor <br></br> strategy user <br></br> experience
              hypotheses <br></br> investor.”
            </p>
            <div>
              <img
                width="58px"
